...
export default function Time({ time = "25:00", changeTitle, focusStatus = 'focus' }) {
  ...
  return (
    <div className="rounded-full border-8 border-red-400 w-72 md:w-96 h-72 md:h-96  flex flec-col items-center justify-center grow-0 shrink-0">
      <p className="text-red-100 text-7xl md:text-9xl">{timer}</p>
    </div>
  );
}
